...
struct HugoApp: App {
    var sharedModelContainer: ModelContainer = {
        ...
        let logger = Logger(
            subsystem: "com.ordellnielsen.Hugo",
            category: "CloudKit"
        )
        ...
        logger.info("Initializing ModelContainer...")
            ...
            if ProcessInfo.processInfo.environment["XCODE_RUNNING_FOR_PREVIEWS"]
                ...
                || ProcessInfo.processInfo.environment[
                    "XCODE_SERVICE_ACCOUNT_STATUS"
                ] != nil
            {
                print(
                    "Initializing ModelContainer with in-memory storage for previews..."
                )
                ...
                do {
                    ...
                    fatalError(
                        "Still could not create ModelContainer: \(error)"
                    )
                }
            }
        #endif
